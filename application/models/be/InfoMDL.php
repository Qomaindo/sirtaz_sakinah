...
class InfoMDL extends CI_Model
{

	var $table  = 't_informasi';
	var $column_order = array('judul_info', 'sub_judul', 'tgl_info');
	var $column_search = array('judul_info', 'sub_judul', 'tgl_info');
	var $order = array('judul_info'  => 'asc',);
