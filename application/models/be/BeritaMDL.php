...
class BeritaMDL extends CI_Model
{
	...
	var $table  = 't_berita';
	var $column_order = array('judul_berita', 'sub_judul_berita', 'tgl_berita');
	var $column_search = array('judul_berita', 'sub_judul_berita', 'tgl_berita');
	var $order = array('judul_berita'  => 'asc',);
